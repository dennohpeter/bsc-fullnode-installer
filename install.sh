...
# Create the start.sh.
echo "./geth_linux --config ./config.toml --datadir ./node --cache 8000 --rpc.allow-unprotected-txs --txlookuplimit=0 --tries-verify-mode=none --pruneancient=true --diffblock=5000" > /home/geth/start.sh
